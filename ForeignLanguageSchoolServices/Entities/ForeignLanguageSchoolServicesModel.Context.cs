...
namespace ForeignLanguageSchoolServices.Entities
{
    ...
    public partial class ForeignLanguageSchoolServicesEntities : DbContext
    {
        public ForeignLanguageSchoolServicesEntities()
            : base("name=ForeignLanguageSchoolServicesEntities")
        {
        }
